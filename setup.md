...
เนื่องจากเราจะใช้ Vue ในการเขียนเว็บ ดังนั้นต้องติดตั้ง Vue CLI ก่อน เพื่อความสะดวกในการใช้งาน

เริ่มต้นด้วยการเปิด `Node.js command prompt` ขึ้นมา (จะอยู่ใน Start menu ของ Windows อยู่แล้ว ลองไล่หาดู) จะมี `Node.js` กับ `Node.js command prompt` อันนี้จะใช้ `Node.js command prompt` นะ (อันนี้เป็นตัวหลักที่เราจะใช้ ดังนั้ต่อไปอาจจะเรียกว่า `Node.js CMD` แทน)

เปิดขึ้นมาจะเป็นหน้าจอดำ ๆ ให้สั่ง

`yarn global add vue-cli`

ตัว yarn จะดาวโหลด และติดตั้ง package นี้ให้จนเสร็จ ก็เรียบร้อย เดี๋ยวเราจะเรียกใช้มันตอนที่สร้าง project

![Install Vue CLI](images/setup/add-vue-cli.png)

*warning ต่าง ๆ ไม่ต้องสนใจ ส่วนใหญ่จะไม่มีอะไรสำคัญ ดังนั้นปล่อยผ่านไปจนกว่าคิดว่า มันมีปัญหาเพราะเจ้านี่จริง ๆ*
